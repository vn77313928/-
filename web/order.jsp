...
<%
    ...
    UserBean buyeruserBean = (UserBean) request.getSession().getAttribute("userBean");
        ...
        <div class="row row--grid">
            <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                <div class="main__title main__title--sidebar">
                    <h2><%=imageBean.getImgname()%></h2>
                    <p><%=imageBean.getStory()%></p>
                </div>
                <ul class="contacts__list">
<%--                    <li><a href="tel:88002345678">8 800 234-56-78</a></li>--%>
                    <li><a href="mailto:<%=usershowBean.getEmail()%>">联系作者：<%=usershowBean.getEmail()%></a></li>
<%--                    <li><a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom" class="open-map">221B Baker St, Marylebone, London</a></li>--%>
            ...
            <div class="col-12 col-md-6 col-lg-7 col-xl-8">
                <form action="BuyServlet" class="sign__form sign__form--contacts" method="post">
                    <div class="row">
                        <div class="col-12">
                            <div class="main__title main__title--sidebar">
                                <h3>受让人信息</h3>
                        ...
                        <div class="col-12 col-xl-3">
                            <button type="submit" class="sign__btn">提交订单</button>
                        </div>
                    </div>
                </form>
            </div>

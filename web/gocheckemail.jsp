    ...
    <div class="row row--grid">
      ...
      <div class="col-12">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb__item breadcrumb__item--active">check email</li>
        </ul>
      </div>
      <!-- end breadcrumb -->
        ...
        <div class="page-404">
          <div class="page-404__wrap">
            <div class="page-404__content">
              <h1 class="page-404__title">Check</h1>
              <p class="page-404__text">已向您邮箱发送验证邮件，请前往验证~~</p>
              <a href="index.jsp" class="page-404__btn">返回</a>
            </div>
          </div>
        </div>
      </div>

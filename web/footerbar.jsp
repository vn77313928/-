        ...
        <div class="row">
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                <div class="footer__logo">
                    <img src="data/systemimages/logo3.png" alt=""  style="width: 300px; height: 100px">
                </div>
                <p class="footer__tagline">精选照片在线贩售中心 <br>NFTs、摄影作品等各类图像提供挑选购买贩售<br>该买了吧？哪次不是买爆！还不快动动手指买起来。</p>
                ...
                <div class="footer__lang">
                    <a class="footer__lang-btn" href="#" role="button" id="dropdownLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="data/systemimages/china.svg" alt="">
                        <span>中文</span>
                    </a>

                    <ul class="dropdown-menu footer__lang-dropdown" aria-labelledby="dropdownLang">
                        <li><a href="#"><img src="data/systemimages/spain.svg" alt=""><span>español</span></a></li>
                        <li><a href="#"><img src="data/systemimages/russia.svg" alt=""><span>Русский</span></a></li>
                        <li><a href="#"><img src="data/systemimages/uk.svg" alt=""><span>English</span></a></li>
                    </ul>
                </div>
            </div>

            <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
                <h6 class="footer__title">NTF 图片交易市场</h6>
                <div class="footer__nav">
                    <a href="explore.jsp">探索</a>
                    <a href="explore.jsp">动态</a>
                    <a href="myzone.jsp">个人空间</a>
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                <div class="row">
                    <div class="col-12">
                        <h6 class="footer__title">探索风格</h6>
                    </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
                <h6 class="footer__title">社群</h6>
                <div class="footer__nav">
                    <a href="index.jsp">Market-SCUTVK</a>
                    <a href="https://scutvk.cn/">SCUTVK's Blog</a>
                    <a href="faq.jsp">服务中心</a>
                    <a href="contacts.jsp">联系我们</a>
                </div>
            </div>
        </div>

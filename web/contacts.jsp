        ...
        <div class="row row--grid">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="sign__group">
                                <input type="text" username="username" class="sign__input" placeholder="Name">
                            </div>
                        </div>

                        <div class="col-12 col-md-6">
                            <div class="sign__group">
                                <input type="text" username="email" class="sign__input" placeholder="Email">
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="sign__group">
                                <input type="text" username="subject" class="sign__input" placeholder="Subject">
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="sign__group">
                                <textarea username="text" class="sign__textarea" placeholder="Type your message"></textarea>
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                ...
                <ul class="contacts__list">
                    ...
                    <li><a href="mailto:support@market.scutvk.cn">support@market.scutvk.cn</a></li>
                ...
                <div class="contacts__social">
                    ...
                    <a href="mailto:support@非必要不外出.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,4H5A3,3,0,0,0,2,7V17a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V7A3,3,0,0,0,19,4Zm-.41,2-5.88,5.88a1,1,0,0,1-1.42,0L5.41,6ZM20,17a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V7.41l5.88,5.88a3,3,0,0,0,4.24,0L20,7.41Z"/></svg></a>
                </div>
            </div>
        </div>

      ...
      <div class="col-12 col-xl-8">
        <div class="asset__item">
          ...
          <div class="share share--asset">
            ...
            <a href="#" class="share__link share__link--link">
          ...
          <!-- likes -->
          <button class="asset__likes" type="button"  onclick='location.href=("<%=request.getContextPath() + "/LikeButtonServlet?imgid=" + imageBean.getImgid()%>")'>
...
<%--              <div class="asset__clock"></div>--%>
          ...
          <%
            // check if userBean is the owner of the image
            if (userBean != null && userBean.getUid() == imageBean.getUid()) {
          %>
            <%-- show the edit button --%>
            <button class="asset__btn asset__btn--full asset__btn--clr" type="button" onclick='location.href=("<%=request.getContextPath() + "/itemedit.jsp"%>")'>编辑</button>
          <%
            } else {
          %>
            <!-- actions -->
            <div class="asset__wrap">
              <button class="asset__btn asset__btn--full asset__btn--clr" type="button" onclick='location.href=("<%=request.getContextPath() + "/GotoOrderServlet"%>")'>立即购买</button>
              <%
                ...
                if (flag) {
              %>
                <button class="asset__btn asset__btn--full asset__btn--clr" type="button" onclick='location.href=("<%=request.getContextPath() + "/AddToShoppingCartServlet"%>")'>加入购物车</button>
              <%
                  } else {
                  // set button to be disabled
              %>
                <button class="asset__btn asset__btn--full asset__btn--clr" type="button" style="background-color: gray" disabled>已添加购物车</button>
              <%
                  }
              %>
            </div>

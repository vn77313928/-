...
<main class="main">
      ...
      <div class="row">
        <div class="col-12">
          <div class="home__content">
            <h1 class="home__title">全校最大的图片交易市场</h1>
            <h2 class="home__text">The largest Picture Trading Market in SCUT</h2>
            <p class="home__text">数字货币图片交易市场，您可以在此使用ETH进行交易 <br>购买、出售和发现独家数字资产。</p>

            <div class="home__btns">
              <a href="explore.jsp" class="home__btn home__btn--clr">浏览市场</a>
              <a href="register.jsp" class="home__btn">注册新用户</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <section class="row row--grid">
      ...
      <div class="col-12">
        <div class="main__title">
          <h2><a href="explore.jsp">人气最佳</a></h2>
        </div>
      </div>
      <!-- end title -->
    ...
    <section class="row row--grid">
      ...
      <div class="col-12">
        <div class="main__title">
          <h2><a href="explore.jsp">最新发布</a></h2>
        </div>
      </div>
      <!-- end title -->
      ...
      <div class="col-12">
        <div class="main__carousel-wrap">
          <div class="main__carousel main__carousel--explore owl-carousel" id="explore">
            <jsp:include page="publicitemshow/latestitems.jsp"></jsp:include>
          </div>
    ...
    <div class="row row--grid">
      ...
      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
        <div class="feature">
          ...
          <p class="feature__text">Once you’ve set up your wallet of choice, connect it to NFT marketplace by clicking this link. <br><a href="register.jsp">Connect my wallet</a>.</p>
        </div>
      </div>

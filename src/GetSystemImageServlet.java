...
@WebServlet(name = "GetSystemImageServlet",
        value = "/data/systemimages/*")
@MultipartConfig
public class GetSystemImageServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        File file = new File(req.getServletContext().getInitParameter("datapath") + "/systemimages", filename);
